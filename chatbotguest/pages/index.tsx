...
const Home: React.FC<HomeProps> = ({
  ...
  const [useRAG, setUseRAG] = useState<'true' | 'false'>('true');
  ...
  const handleRagMode = (useRAG: 'true' | 'false') => {
    setUseRAG(useRAG);
  ...
  useEffect(() => {
    ...
    const useRAG = localStorage.getItem('useRAG');
    if (useRAG) {
      setUseRAG(useRAG as 'true' | 'false');
    }
  ...
  return (
    <>
      <Head>
        <title>GPT Phật là một bộ công cụ chatbot tiên tiến cho mô hình ChatGPT về Phật Giáo nguyên thủy tại Việt Nam</title>
        <meta name="description" content="Hỏi đáp Kinh Phật, Phật Giáo, Phật Pháp bằng trí tuệ nhân tạo ChatGpt, cung cấp các kiến thức cơ bản về Đạo Phật" />
