...
const buildBasePrompt = (
  ...
  if (assistant) {
    fullPrompt += `<INJECT ROLE>\nBạn không phải là AI. Bạn là ${assistant.name}.\n</INJECT ROLE>\n\n`
  }
...
function buildRetrievalText(fileItems: Tables<"file_items">[]) {
  ...
  return `Sử dụng các bối cảnh dưới đây, trả lời câu hỏi một cách đầy đủ kiến thức trong Phật Giáo. Nếu bạn không biết câu trả lời, hãy trả lời "Tôi không biết". \n\n${retrievalText}`
}
